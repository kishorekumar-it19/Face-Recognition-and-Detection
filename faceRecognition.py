...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('D:\\Face Recognition and identification\\FaceRecognition-master\\HaarCascade\\haarcascade_frontalface_default.xml')#Load haar classifier
